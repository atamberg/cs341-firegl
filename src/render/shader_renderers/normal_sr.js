...
export class NormalShaderRenderer extends ShaderRenderer {
    ...
    constructor(regl, resource_manager) {
        resource_manager.resources["normal.vert.glsl"] = normal_vertex_shader();
        resource_manager.resources["normal.frag.glsl"] = normal_fragment_shader();
...
function normal_vertex_shader() {
    return `
          ...
          void main() {
            ...
            vColor = mat_model_to_world * vec4(vertex_normal, 0);
          }
        `;
}

function normal_fragment_shader() {
    return `
          precision mediump float;
